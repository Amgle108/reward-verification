...
if run_mode == 'slc_prizes':
    ...
    raffle_seed = 'Silencio_Raffle_Season2:Transparency46%-Silence33%-Trust15%-Privacy6%-SLC:'
elif run_mode == 'physical_prizes':
    input_prize_matrix = 'token_assignment/physical_prizes.csv'
    raffle_seed = 'Silencio_Raffle_Season2:Transparency46%-Silence33%-Trust15%-Privacy6%-Physical:'

prize_assignment = pd.read_csv(input_prize_matrix)
total_prize_quantity = prize_assignment['prize_quantity'].sum()
# get user data
user_data = pd.read_csv('silencio_raffle_eligible_users_april_2025.csv', dtype={'raffle_tickets': 'int64'})
